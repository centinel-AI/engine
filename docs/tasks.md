...
| `test:plan:ovh` | `ENGINE_OVH_ENDPOINT`, `ENGINE_OVH_APPLICATION_KEY`, `ENGINE_OVH_APPLICATION_SECRET`, `ENGINE_OVH_CONSUMER_KEY`; `ENGINE_OVH_S3_ACCESS_KEY`, `ENGINE_OVH_S3_SECRET_KEY` (for `s3_bucket` tests) |
