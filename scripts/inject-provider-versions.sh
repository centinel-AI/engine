...
# Known placeholders: __AZURERM_VERSION__, __AZUREAD_VERSION__, __AWS_PROVIDER_VERSION__, __GOOGLE_PROVIDER_VERSION__, __OCI_PROVIDER_VERSION__, __OVH_PROVIDER_VERSION__, __REQUIRED_VERSION__.
#
...
substitute_file() {
  ...
  sed \
    ...
    -e "s|__OVH_PROVIDER_VERSION__|${OVH_PROVIDER_VERSION:-}|g" \
